...
<script>
    var app = angular.module('app',[]).controller('ctrl',function ($scope) {
        ...
        $scope.doalipay = function () {
            ...
            var url="/alipay/doalipaypc.form?out_trade_no="+$scope.data.out_trade_no+"&subject="+$scope.data.subject+"&total_amount="+$scope.data.total_amount + "&body=" + $scope.data.body + "&product_code=FAST_INSTANT_TRADE_PAY" + "&return_url="+ domainName + "/views/test_return.form" + "&notify_url=" + domainName + "/views/test_notify.form";
